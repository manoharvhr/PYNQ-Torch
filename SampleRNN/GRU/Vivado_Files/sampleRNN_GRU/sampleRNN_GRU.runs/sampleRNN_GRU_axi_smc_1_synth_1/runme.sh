...
HD_PWD='C:/ECTE433_LabFiles/sampleRNN_GRU/sampleRNN_GRU.runs/sampleRNN_GRU_axi_smc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sampleRNN_GRU_axi_smc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sampleRNN_GRU_axi_smc_1.tcl
