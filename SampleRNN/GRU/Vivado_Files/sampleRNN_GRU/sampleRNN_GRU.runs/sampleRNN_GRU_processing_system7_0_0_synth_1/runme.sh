...
HD_PWD='C:/ECTE433_LabFiles/sampleRNN_GRU/sampleRNN_GRU.runs/sampleRNN_GRU_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sampleRNN_GRU_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sampleRNN_GRU_processing_system7_0_0.tcl
