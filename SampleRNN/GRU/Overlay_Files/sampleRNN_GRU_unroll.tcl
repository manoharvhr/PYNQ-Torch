...
################################################################
# This is a generated script based on design: sampleRNN_GRU
#
...
# source sampleRNN_GRU_script.tcl
...
xilinx.com:hls:sampleRNN_GRU:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: sampleRNN_GRU_0, and set properties
  set sampleRNN_GRU_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:sampleRNN_GRU:1.0 sampleRNN_GRU_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins sampleRNN_GRU_0/input_r]
  ...
  create_bd_addr_seg -range 0x00400000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
