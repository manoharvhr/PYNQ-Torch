...
HD_PWD='C:/ECTE433_LabFiles/compute_weight/compute_weight.runs/compute_weight_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_weight_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compute_weight_processing_system7_0_0.tcl
