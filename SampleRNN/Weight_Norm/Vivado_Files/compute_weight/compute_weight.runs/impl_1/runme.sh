...
HD_PWD='C:/ECTE433_LabFiles/compute_weight/compute_weight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_weight_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source compute_weight_wrapper.tcl -notrace
