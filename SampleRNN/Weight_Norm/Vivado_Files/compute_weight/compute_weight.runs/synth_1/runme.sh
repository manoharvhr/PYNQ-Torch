...
HD_PWD='C:/ECTE433_LabFiles/compute_weight/compute_weight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_weight_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compute_weight_wrapper.tcl
