...
#ifndef __compute_weight_64eOg__HH__
#define __compute_weight_64eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_weight_64eOg) {
    ...
    SC_CTOR(compute_weight_64eOg):  ACMP_uitofp_U ("ACMP_uitofp_U") {
