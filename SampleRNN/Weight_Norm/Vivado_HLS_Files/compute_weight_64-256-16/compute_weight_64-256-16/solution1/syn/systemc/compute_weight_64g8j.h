...
#ifndef __compute_weight_64g8j__HH__
#define __compute_weight_64g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(compute_weight_64g8j) {
    ...
    SC_CTOR(compute_weight_64g8j):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
