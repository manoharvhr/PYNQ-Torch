...
HD_PWD='C:/ECTE433_LabFiles/custom_backward/custom_backward.runs/custom_backward_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_backward_rst_ps7_0_100M_0.tcl
