...
HD_PWD='C:/ECTE433_LabFiles/backward_lite_features/backward_lite_features.runs/custom_backward_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_backward_xbar_0.tcl
