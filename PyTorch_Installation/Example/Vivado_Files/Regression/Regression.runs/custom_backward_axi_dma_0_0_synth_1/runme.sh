...
HD_PWD='C:/ECTE433_LabFiles/backward_lite/backward_lite.runs/custom_backward_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_backward_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_backward_axi_dma_0_0.tcl
