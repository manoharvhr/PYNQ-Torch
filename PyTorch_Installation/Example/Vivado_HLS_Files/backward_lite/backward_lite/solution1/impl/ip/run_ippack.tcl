...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 bias R 0x0 "Data signal of bias" {{0 32 bias R 0 "Bit 31 to 0 Data signal of bias"}}} {0x14 bias_ctrl R 0x0 "Control signal of bias" {{0 1 bias_ap_vld R 0 "Control signal bias_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 w1 R 0x0 "Data signal of w1" {{0 32 w1 R 0 "Bit 31 to 0 Data signal of w1"}}} {0x1c w1_ctrl R 0x0 "Control signal of w1" {{0 1 w1_ap_vld R 0 "Control signal w1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 w2 R 0x0 "Data signal of w2" {{0 32 w2 R 0 "Bit 31 to 0 Data signal of w2"}}} {0x24 w2_ctrl R 0x0 "Control signal of w2" {{0 1 w2_ap_vld R 0 "Control signal w2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 w3 R 0x0 "Data signal of w3" {{0 32 w3 R 0 "Bit 31 to 0 Data signal of w3"}}} {0x2c w3_ctrl R 0x0 "Control signal of w3" {{0 1 w3_ap_vld R 0 "Control signal w3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 w4 R 0x0 "Data signal of w4" {{0 32 w4 R 0 "Bit 31 to 0 Data signal of w4"}}} {0x34 w4_ctrl R 0x0 "Control signal of w4" {{0 1 w4_ap_vld R 0 "Control signal w4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 w5 R 0x0 "Data signal of w5" {{0 32 w5 R 0 "Bit 31 to 0 Data signal of w5"}}} {0x3c w5_ctrl R 0x0 "Control signal of w5" {{0 1 w5_ap_vld R 0 "Control signal w5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 596 II x}
