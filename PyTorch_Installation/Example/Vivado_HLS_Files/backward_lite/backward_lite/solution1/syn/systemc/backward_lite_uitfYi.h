...
#ifndef __backward_lite_uitfYi__HH__
#define __backward_lite_uitfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(backward_lite_uitfYi) {
    ...
    SC_CTOR(backward_lite_uitfYi):  ACMP_uitofp_U ("ACMP_uitofp_U") {
