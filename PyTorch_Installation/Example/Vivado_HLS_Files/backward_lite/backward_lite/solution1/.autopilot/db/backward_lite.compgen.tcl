...
set ID 11
set hasByteEnable 0
set MemName backward_lite_smobkb
...
set ID 12
set hasByteEnable 0
set MemName backward_lite_batcud
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 160
...
set ID 13
set hasByteEnable 0
set MemName backward_lite_nn_dEe
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 32
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 14 \
			corename backward_lite_AXILiteS_axilite \
			name backward_lite_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler backward_lite_AXILiteS_s_axi
}
