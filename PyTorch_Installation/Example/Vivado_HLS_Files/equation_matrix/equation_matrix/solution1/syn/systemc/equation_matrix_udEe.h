...
#ifndef __equation_matrix_udEe__HH__
#define __equation_matrix_udEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(equation_matrix_udEe) {
    ...
    SC_CTOR(equation_matrix_udEe):  ACMP_uitofp_U ("ACMP_uitofp_U") {
